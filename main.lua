                    ...
                    function SectionFunctions:Grid(Props)
                        ...
                        local function FilterItems()
                            ...
                            for _, Item in ipairs(GridItems) do
                                -- Use plain text search (4th argument = true) to avoid pattern matching errors
                                if FilterText == "" or (Item.Name and Item.Name:lower():find(FilterText, 1, true)) then
                        ...
                        -- Move SearchBox connection here, after RefreshGrid is defined
